            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="step">
                        ...
                        <form method="post" action="<?php echo base_url() ?>Contact/addNewMessage" id="contactform">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <button type="submit" class="btn_1 green btn-block">Send</button>
                        </form>
                    </div>
                </div>
                <!-- End col-md-8 -->
                ...
                <div class="col-md-4">
                    <div class="box_style_1">
                        ...
                        <p>
                            Route touristique Jinene El Kantaoui,<br>
                            Port El Kantaoui,<br>
                            Sousse,Tunisie 4089
                        </p>
                        <hr>
                        ...
                        <ul id="contact-info">
                            ...
                            <li><a href="#">contact@palmyrahotels.tn</a>
                            </li>
                        </ul>
                    </div>
