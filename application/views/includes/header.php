                ...
                <div class="col-4">
                    <div id="logo" >
                      ...
                      <a href="<?php echo base_url() ?>">
                        <img src="<?php echo base_url()?>assets/img/logo-1.png" width="160" height="34" alt="City tours" class="logo_normal"></a>
                      <a href="<?php echo base_url() ?>">
                        <img src="<?php echo base_url()?>assets/img/logo_sticky-1.png" width="160" height="34" alt="City tours" class="logo_sticky"></a>
                    </div>
                </div>
                <nav class="col-8">
