...
<section class="footer-area section-bg padding-top-40px padding-bottom-30px">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <div class="footer-logo padding-bottom-30px">
                        <a href="<?php echo base_url() ?>" class="foot__logo"><img src="<?php echo base_url() ?>assets/images/logo.png" alt="logo" width="200px"></a>
                    </div><!-- end logo -->
                    ...
                    <ul class="list-items pt-3">
                        ...
                        <li>+123-456-789</li>
                        <li><a href="#">info@palmyra.com.tn</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
            ...
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <h4 class="title curve-shape pb-3 margin-bottom-20px" data-text="curvs">Hotels</h4>
                    <ul class="list-items list--items">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copy-right padding-top-30px text-center">
                    <p class="copy__desc">
                        &copy; Copyright Palmyra Hotels 2021. Made with
                        <span class="la la-heart"></span> by <a href="https://themeforest.net/user/techydevs/portfolio">Koussay Bahaedinne Maiza</a>
                    </p>
                </div><!-- end copy-right -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
                ...
                <div class="modal-body">
                    <div class="contact-form-action">
                        <form method="post">
                            ...
                            <div>
                                <select name="countryCode" class="select-contain-select" id="" required>
    ...
    <div class="modal fade" id="loginPopupForm" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="contact-form-action">
                        <form method="post" action="<?php echo base_url() ?>Login/loginMe">
                            <div class="input-box">
                                <label class="label-text">E-mail</label>
                                <div class="form-group">
                                    <span class="la la-user form-icon"></span>
                                    <input class="form-control" type="mail" name="email" placeholder="Type your e-mail">
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box">
                                <label class="label-text">Password</label>
    ...
    <div class="modal fade" id="menu" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title title" id="exampleModalLongTitle2">Menu</h5>
                        <p class="font-size-14">Hello! Welcome to your account</p>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="la la-close"></span>
                ...
                <div class="modal-body">
                    <div style="padding-bottom: 20px;">
                        <a href=""  class="theme-btn w-100" style="text-align: center; " > <i class="las la-history"></i> my reservations</a>
                    </div>
                    <div style="padding-bottom: 20px;">
                        <a href=""  class="theme-btn w-100" style="text-align: center;" > <i class="las la-scroll"></i> my complaints</a>
                    </div>
