            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-img-carousel carousel-action carousel--action">
                        <div class="card-img">
                            <a href="room-details.html" class="d-block">
                                <img src="<?php echo base_url() ?>assets/images/img5.jpg" alt="hotel-img">
                            </a>
                        </div>
                         <div class="card-img">
                            <a href="room-details.html" class="d-block">
                                <img src="<?php echo base_url() ?>assets/images/img29.jpg" alt="hotel-img">
                            </a>
                        </div>
                         <div class="card-img">
                            <a href="room-details.html" class="d-block">
                                <img src="<?php echo base_url() ?>assets/images/img30.jpg" alt="hotel-img">
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card-item room-card">
                    <div class="card-img-carousel carousel-action carousel--action">
                        <div class="card-img">
                            <a href="room-details.html" class="d-block">
                                <img src="<?php echo base_url() ?>assets/images/img31.jpg" alt="hotel-img">
                            </a>
                        </div>
                        <div class="card-img">
                            <a href="room-details.html" class="d-block">
                                <img src="<?php echo base_url() ?>assets/images/img32.jpg" alt="hotel-img">
                            </a>
                        </div>
                        <div class="card-img">
                            <a href="room-details.html" class="d-block">
                                <img src="<?php echo base_url() ?>assets/images/img33.jpg" alt="hotel-img">
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
